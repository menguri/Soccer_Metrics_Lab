...
def convert_to_actions(
    ...
    # duration  & timestamp 추가
    actions["duration"] = events.duration
    actions["extra"] = events.extra
    # action["freeze_frame_360"] = events.freeze_frame_360  ->  json 주소가 유효하지 않은 것으로 뜬다.
